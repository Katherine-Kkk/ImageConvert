...
# 对于dark：0-0.2正常 0.3-0.5弱暗光(取0.3) 0.7-0.8强暗光(取0.6)
# python K.py ./GoPro/input ./GoPro_dark/weak03 --effect dark --strength 0.3
# python K.py ./GoPro/input ./GoPro_dark/strong06 --effect dark --strength 0.6

# 对于dark：0-0.2正常 0.3-0.4弱暗光(取0.3) 0.5-0.7强弱光(取0.6)
# python K.py ./GoPro/input ./GoPro_overexpose/weak03 --effect overexpose --strength 0.3
# python K.py ./GoPro/input ./GoPro_overexpose/strong06 --effect overexpose --strength 0.6

# python K.py ./input ./output --effect dark --strength 0.5
